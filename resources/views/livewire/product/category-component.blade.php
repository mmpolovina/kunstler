                ...
                <div class="sidebar">
                    ...
                    <div class="collapse collapse-filters" id="collapseFilters">
                        ...
                        <div class="filter-price">
                            <input type="number" class="form-control" value="{{$min_price}}" wire:model.live.debounce.300ms='min_price'>
                            <input type="number" class="form-control" value="{{$max_price}}" wire:model.live.debounce.300ms='max_price'>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" aria-label="Show:" wire:change='changeLimit' wire:model='limit'>
                                    @foreach ($limitList as $k => $item)
                                             <option value="{{ $item }}"  @if ($item == $limit) selected @endif wire:key='{{ $k}}'>{{ $item}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
