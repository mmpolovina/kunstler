            ...
            <div class="card-body">
                ...
                <form wire:submit="save">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset($product->getImage()) }}" alt="Image preview" width="150" class="mb-2">
                        ...
                        @if (!$errors->has('image')  && $image)
                            <div class="mt-2" style="position: relative; display: inline-block;">
                                ...
                                <img src="{{!empty($image) ? $image->temporaryUrl() : '' }}"
                                alt="Image preview"
                                width="250"
                                >
                                ...
                                <div class="mt-2" style="position: relative; display: inline-block;">
                                    ...
                                    <div class="text-danger position-absolute" style="top:0px; right: 0px; cursor:pointer;">
                                        <button type="button" class="btn btn-sm btn-danger"
                                                wire:click="removeGalleryItem('{{ $k }}')"
                                                wire:confirm="Are you sure you want to delete this photo?">X</button>
                                    </div>
                                </div>
                            @endforeach
                        @endif
